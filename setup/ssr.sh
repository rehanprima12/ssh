...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/apih46/mon/main/core/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/apih46/mon/main/setup/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://raw.githubusercontent.com/apih46/mon/main/add/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://raw.githubusercontent.com/apih46/mon/main/del/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://raw.githubusercontent.com/apih46/mon/main/renew/renewssr.sh && chmod +x /usr/bin/renewssr
wget -O /usr/bin/trialssr https://raw.githubusercontent.com/apih46/mon/main/trial/trialssr.sh && chmod +x /usr/bin/trialssr
